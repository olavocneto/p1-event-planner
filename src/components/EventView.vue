<template>
  <section class="section is-medium eventview">
    <div class="container">
      <h1 class="title is-2">Event view</h1>

      <div class="content">
        <h2>{{ $route.params.event.name }}</h2>
...
export default {
  ...
  data() {
    ...
    return {
      // item: JSON.parse(localStorage.getItem(STORAGE_KEY)),
    };
  },
};
</script>
